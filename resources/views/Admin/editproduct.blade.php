...
<div class="container-fluid">
    <div class="card p-2">
        ...
        <div class="p-2 card-body">
            <form class="d-flex justify-content-between" action="{{route('editproduct',['id'=>$product->id])}}" method="POST" enctype="multipart/form-data">
            <input name="_method" type="hidden" value="PUT">
                @csrf                                                     
                <div class="product_l_hand col-lg-8">
                    <div class="form-group">
                        <label for="p_name">Product Name</label>
                        <input type="text" name="p_name" class="form-control form-control-md" id="p_name" placeholder="Product Name" value="{{$product->p_name}}" required>
                ...
                <div class="product_r_hand col-lg-3">
                    ...
                    <div class="form-group ">
                        ...
                        <input name="b_price" type="number" value="{{$product->b_price}}" class="form-control" id="Buying"required>
                    </div>
                    <div class="form-group ">
                        <label for="mrp">MRP Price</label>
                        <input name="mrp_price" type="number" value="{{$product->mrp_price}}" class="form-control" id="mrp"required>
                    </div>
                    <div class="form-group ">
                        <label for="selling">Selling Price</label>
                        <input name="s_price" type="number" value="{{$product->s_price}}" class="form-control" id="selling"required>
                    </div>
